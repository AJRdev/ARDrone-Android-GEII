...
public class GereManette
{
     ...
     * @return
     * An <i>integer</i> that represent the button that has generated the <i>event</i>:</br>
     * <b>0</b> if it is <i>none</i>. </br>
     * <b>1</b> if it is <i>A</i>. </br>
     * <b>2</b> if it is <i>B</i>. </br>
     * <b>3</b> if it is <i>X</i>. </br>
     * <b>4</b> if it is <i>Y</i>. </br>
     * <b>5</b> if it is <i>START</i>. </br>
     * <b>6</b> if it is <i>SELECT</i>. </br>
     * <b>7</b> if it is <i>R1</i>. </br>
     * <b>8</b> if it is <i>L1</i>. </br>
     * <b>9</b> if it is <i>R2</i>. </br>
     * <b>10</b> if it is <i>L2</i>. </br>
