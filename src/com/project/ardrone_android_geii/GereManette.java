...
public class GereManette
{
     ...
     * @return
     * <br> An <i>integer</i> that represent the button that has generated the <i>event</i>:</br>
     * <br> <b>0</b> if it is <i>none</i>. </br>
     * <br> <b>1</b> if it is <i>A</i>. </br>
     * <br> <b>2</b> if it is <i>B</i>. </br>
     * <br> <b>3</b> if it is <i>X</i>. </br>
     * <br> <b>4</b> if it is <i>Y</i>. </br>
     * <br> <b>5</b> if it is <i>START</i>. </br>
     * <br> <b>6</b> if it is <i>SELECT</i>. </br>
     * <br> <b>7</b> if it is <i>R1</i>. </br>
     * <br> <b>8</b> if it is <i>L1</i>. </br>
     * <br> <b>9</b> if it is <i>R2</i>. </br>
     * <br> <b>10</b> if it is <i>L2</i>. </br>
	 ...
	 public double GetJ1PosY(MotionEvent motionEvent) {
	     ...
	     */
		 ...
		 public double GetJ2PosY(MotionEvent motionEvent) {
		     ...
		     * @return
		     * An <i>integer</i> that represent <b>the direction pressed</b> on the directional pad:</br>
		     * <b>0</b> if it is <i>none</i>.</br>
		     * <b>1</b> if it is <i>UP</i>.</br>
		     * <b>2</b> if it is <i>RIGHT</i>.</br>
		     * <b>3</b> if it is <i>DOWN</i>.</br>
		     * <b>4</b> if it is <i>LEFT</i>.</br>
