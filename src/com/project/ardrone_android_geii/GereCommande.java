...
public class GereCommande {
		...
		public static final  String i5Pourcents = "1028443341";					// DEFINI DES VARIABLES CONSTANTES DES COMMANDES
		...
		String roll;				// declaration variable position
		String pitch;
		String gaz;
		String yaw;
		String sData;
		
		public GereCommande(){									//CONSTRUCTEUR SANS ARGUMENT	
		...
		public void GenerateCMDJoy1(double i, double j){				// Genere les variable du Joystick 1 en fonction des coordonnée i et j
			if(i >= -10 && i <= -8.75d){
				roll =iM100Pourcents;
			}
		...
		public void GenerateCMDJoy2(double i, double j){			// Genere les variable du Joystick 1 en fonction des coordonnée i et j
			if(i >= -10 && i <= -8.75d){
				yaw =iM100Pourcents;
			}
			else if(i > -8.75d && i <= -6.25d){
			...
			public String GeneratePCMD(String s){					// Genere sData, qui contient les 4 variables des 4 cannaux directionnels du drone
